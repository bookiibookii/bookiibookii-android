...
val bookiiTypography = BookiiTypography(
    ...
    regular28 = pretendard(FontWeight.Normal, 28),
    ...
    semibold15 = pretendard(FontWeight.SemiBold, 15),
    semibold16 = pretendard(FontWeight.SemiBold, 16),
    semibold18 = pretendard(FontWeight.SemiBold, 18),
    semibold20 = pretendard(FontWeight.SemiBold, 20),
    semibold28 = pretendard(FontWeight.SemiBold, 28),
