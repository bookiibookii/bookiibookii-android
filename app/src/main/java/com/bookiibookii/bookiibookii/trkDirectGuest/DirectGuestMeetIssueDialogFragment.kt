...
class DirectGuestMeetIssueDialogFragment : DialogFragment() {
    ...
    private var _binding: FragmentDirectGuestMeetIssueDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDirectGuestMeetIssueDialogBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        const val TAG = "DirectGuestMeetIssueDialogFragment"

        private const val ARG_GROUP_ID = "arg_group_id"

        fun newInstance(groupId: Long) =
            DirectGuestMeetIssueDialogFragment().apply {
